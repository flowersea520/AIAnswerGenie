...
public class UserAnswerServiceImpl extends ServiceImpl<UserAnswerMapper, UserAnswer> implements UserAnswerService {
    ...
    public void validUserAnswer(UserAnswer userAnswer, boolean add) {
        ...
        // 从对象中取值
        // 要求前端必须传 user_answer的id，用于幂等的设计
    ...
    public QueryWrapper<UserAnswer> getQueryWrapper(UserAnswerQueryRequest userAnswerQueryRequest) {
        ...
        // 精确查询
        queryWrapper.eq(StringUtils.isNotBlank(choices), "choices", choices);
        queryWrapper.eq(StringUtils.isNotBlank(resultName), "resultName", resultName);
        queryWrapper.eq(StringUtils.isNotBlank(resultDesc), "resultDesc", resultDesc);
        queryWrapper.eq(StringUtils.isNotBlank(resultPicture), "resultPicture", resultPicture);
        queryWrapper.eq(ObjectUtils.isNotEmpty(appId), "appId", appId);
        queryWrapper.eq(ObjectUtils.isNotEmpty(appType), "appType", appId);
        queryWrapper.eq(ObjectUtils.isNotEmpty(resultId), "resultId", appId);
