...
/**
 * @author mortal
 * @date 2024/7/23 23:32
 */
@SpringBootTest
public class SparkAITest extends WebSocketListener {
	...
	public static final String appid = "6a7ecaec";
	public static final String apiSecret = "YTIxN2I1ODBhM2E3ZjQ2MDM3MDdmZWZm";
	public static final String apiKey = "e841b1399f7db5c7154dec5796635506";
	...
	// 构造函数
	public SparkAITest(String userId, Boolean wsCloseFlag) {
		this.userId = userId;
	...
	public static void main(String[] args) throws Exception {
		...
		while (true){
			if(totalFlag){
				...
				for (int i = 0; i < 1; i++) {
					totalAnswer="";
					WebSocket webSocket = client.newWebSocket(request, new SparkAITest(i + "",
							false));
				}
			}else{
				Thread.sleep(200);
